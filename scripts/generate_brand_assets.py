...
def linkedin_cover():
    ...
    d.text((824, 62), "Datos · Integración", font=font(18, True), fill=GREEN)
    d.text((824, 91), "Automatización · Software", font=font(18, True), fill=GREEN)
    d.text((824, 122), "haleverse.com", font=font(18), fill=MUTED)
